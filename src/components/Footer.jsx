...
const Footer = () => {
  return (
    <div className='bg-[#637789]'>
        <footer className=" bg-[#637789]' section-container footer p-10 bg-base-200 text-base-content">
  <nav>
...
<footer className="bg-[#637789]' footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
  <aside className="items-center grid-flow-col">
    ...
    <p>Zenith Marketing <br/>Providing reliable tech</p>
  </aside> 
